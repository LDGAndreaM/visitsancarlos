...
const SupportChat = forwardRef<SupportChatHandle>(function SupportChat(_props, ref) {
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      from: "agent",
      text: "¡Hola! 👋 Soy parte del equipo de Visit San Carlos. ¿En qué te puedo ayudar hoy? También puedes adjuntar una captura de pantalla de tu problema.",
      time: now(),
    },
  ]);
  ...
  useImperativeHandle(ref, () => ({ sendMessage: (text: string) => push(text) }));
