...
export default function ChooseListingTypeModal({ onClose, onChooseDirectorio, onChooseClasificado }: ChooseListingTypeModalProps) {
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(20,56,64,0.55)", zIndex: 100, display: "flex", alignItems: "center", justifyContent: "center", padding: 20 }}>
      <div
        ...
        style={{ background: "#ffffff", borderRadius: 20, padding: 32, maxWidth: 520, width: "100%", display: "flex", flexDirection: "column", gap: 16, boxShadow: "0 24px 50px rgba(0,0,0,0.25)" }}
      >
