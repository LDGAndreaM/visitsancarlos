...
export default function LoginForm() {
  ...
  const heading = isLogin ? "Accede a tu cuenta de negocio" : "Registra tu negocio gratis";
  const subheading = isLogin ? "Gestiona tu perfil y tu publicidad en Visit San Carlos." : "Crea tu cuenta para publicar tu negocio en el directorio.";
  const ctaLabel = isLogin ? "Iniciar sesión" : "Crear cuenta";
    ...
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: 44 }}>
      <div style={{ width: "100%", maxWidth: 400, display: "flex", flexDirection: "column", gap: 24 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          ...
          <Link href="/dashboard" style={{ display: "block", textAlign: "center", border: "none", background: "#EB600A", color: "#ffffff", fontWeight: 700, fontSize: 14, padding: 13, borderRadius: 10, cursor: "pointer" }}>
            {ctaLabel}
          </Link>
        </div>
