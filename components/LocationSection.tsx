...
export default function LocationSection({ location, title = "Ubicación", showDirections = true }: LocationSectionProps) {
  ...
  return (
    <section style={{ padding: "24px 48px 0", maxWidth: 1180, margin: "0 auto" }}>
      <div style={{ background: "#ffffff", border: "1px solid #EEF3F3", borderRadius: 18, padding: 28 }}>
        <h2 style={{ margin: "0 0 14px", fontSize: 19, fontWeight: 800, color: "#143840" }}>{title}</h2>
