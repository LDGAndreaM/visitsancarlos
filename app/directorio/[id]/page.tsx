...
import TopActions from "@/components/establecimiento/TopActions";
import EstablishmentHeader from "@/components/establecimiento/EstablishmentHeader";
import Gallery from "@/components/establecimiento/Gallery";
import DescriptionSection from "@/components/establecimiento/DescriptionSection";
import FeaturesSection from "@/components/establecimiento/FeaturesSection";
import LocationSection from "@/components/establecimiento/LocationSection";
...
export default async function Establecimiento({ params }: PageProps) {
  ...
  return (
    <div style={{ maxWidth: "100%", overflowX: "hidden", background: "#ffffff" }}>
      <Header />
      <TopActions businessName={business.name} />
